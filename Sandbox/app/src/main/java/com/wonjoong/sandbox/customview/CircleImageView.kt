...
import com.wonjoong.sandbox.util.dpToPixel
import com.wonjoong.sandbox.util.dpToPixelFloat
...
class CircleImageView @JvmOverloads constructor(
    ...
    private var bitmapPaint: Paint = Paint().apply {
        // 아래는 isAntiAlias에 대한 설명
        // Helper for setFlags(), setting or clearing the ANTI_ALIAS_FLAG bit AntiAliasing
    ...
    //private val radius = if (width > height) height / 2f else width / 2f
